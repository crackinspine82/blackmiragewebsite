...
export const videoItems: VideoItem[] = [
  ...
  },
  {
    ...
    serviceCategory: 'Strategy',
    agency: 'Black Mirage',
    strategicChallenge: 'As an organization focused on high-value consulting and business transformation, GoalSeek\'s digital identity was lagging behind its innovative service offerings. They faced a "perception gap": their expertise was cutting-edge, but their website felt static. To effectively help clients expedite their transformation journeys, GoalSeek needed a platform that demonstrated technological sophistication and thought leadership from the first click.',
